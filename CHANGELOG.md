...
- Refine the custom CSV editor with webtrees language selection, localized Gregorian date entry, explicit metadata translations, and a save-as workflow that preserves unsaved changes.
